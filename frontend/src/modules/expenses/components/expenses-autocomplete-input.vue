...
<script>
import ExpensesFormModal from '@/modules/expenses/components/expenses-form-modal';
import { ExpensesPermissions } from '@/modules/expenses/expenses-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-expenses-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [ExpensesFormModal.name]: ExpensesFormModal,
  },
