<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/expenses/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/expenses/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'expenses' } }"
...
export default {
  name: 'app-expenses-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'expenses/list/hasRows',
      loading: 'expenses/list/loading',
      exportLoading: 'expenses/list/exportLoading',
      selectedRows: 'expenses/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new ExpensesPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new ExpensesPermissions(this.currentUser).import;
    },

    hasPermissionToDestroy() {
      return new ExpensesPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'expenses/list/doExport',
      doRemoveAllSelected:
        'expenses/list/doRemoveAllSelected',
      doDisableAllSelected:
        'expenses/list/doDisableAllSelected',
      doEnableAllSelected:
        'expenses/list/doEnableAllSelected',
      doDestroyAll: 'expenses/destroy/doDestroyAll',
    }),
