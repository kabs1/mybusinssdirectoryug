...
import expensesListExporterFields from '@/modules/expenses/expenses-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!expensesListExporterFields || !expensesListExporterFields.length) {
          throw new Error('expensesListExporterFields is required');
        }
