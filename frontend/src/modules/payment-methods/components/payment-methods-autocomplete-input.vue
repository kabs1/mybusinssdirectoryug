<template>
  <div style="display: flex">
    ...
    ></el-button>
    <portal to="modal">
      <app-payment-methods-form-modal
...
<script>
import PaymentMethodsFormModal from '@/modules/payment-methods/components/payment-methods-form-modal';
import { PaymentMethodsPermissions } from '@/modules/payment-methods/payment-methods-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-payment-methods-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [PaymentMethodsFormModal.name]: PaymentMethodsFormModal,
  },
