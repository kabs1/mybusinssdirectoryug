...
import paymentMethodsListExporterFields from '@/modules/payment-methods/payment-methods-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!paymentMethodsListExporterFields || !paymentMethodsListExporterFields.length) {
          throw new Error('paymentMethodsListExporterFields is required');
        }
        ...
        new Exporter(
          paymentMethodsListExporterFields,
          'paymentMethods',
