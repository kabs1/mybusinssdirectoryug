<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/memos/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/memos/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'memos' } }"
...
export default {
  name: 'app-memos-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'memos/list/hasRows',
      loading: 'memos/list/loading',
      exportLoading: 'memos/list/exportLoading',
      selectedRows: 'memos/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new MemosPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToDestroy() {
      return new MemosPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'memos/list/doExport',
      doRemoveAllSelected:
        'memos/list/doRemoveAllSelected',
      doDisableAllSelected:
        'memos/list/doDisableAllSelected',
      doEnableAllSelected:
        'memos/list/doEnableAllSelected',
      doDestroyAll: 'memos/destroy/doDestroyAll',
    }),
