...
<script>
import SalesFormModal from '@/modules/sales/components/sales-form-modal';
import { SalesPermissions } from '@/modules/sales/sales-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-sales-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [SalesFormModal.name]: SalesFormModal,
  },
