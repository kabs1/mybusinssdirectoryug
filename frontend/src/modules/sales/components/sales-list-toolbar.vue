...
<!--    <router-link :to="{ path: '/sales/new' }" v-if="hasPermissionToCreate">-->
<!--      <el-button icon="el-icon-fa-plus" type="primary" round>-->
<!--        <app-i18n code="common.new"></app-i18n>-->
<!--      </el-button>-->
<!--    </router-link>-->

<!--    <router-link :to="{ path: '/sales/import' }" v-if="hasPermissionToImport">-->
...
<!--    </router-link>-->
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'sales' } }"
...
export default {
  name: 'app-sales-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'sales/list/hasRows',
      loading: 'sales/list/loading',
      exportLoading: 'sales/list/exportLoading',
      selectedRows: 'sales/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new SalesPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new SalesPermissions(this.currentUser).import;
    },

    hasPermissionToDestroy() {
      return new SalesPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'sales/list/doExport',
      doRemoveAllSelected:
        'sales/list/doRemoveAllSelected',
      doDisableAllSelected:
        'sales/list/doDisableAllSelected',
      doEnableAllSelected:
        'sales/list/doEnableAllSelected',
      doDestroyAll: 'sales/destroy/doDestroyAll',
    }),
