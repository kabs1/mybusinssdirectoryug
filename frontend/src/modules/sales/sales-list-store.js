...
import salesListExporterFields from '@/modules/sales/sales-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!salesListExporterFields || !salesListExporterFields.length) {
          throw new Error('salesListExporterFields is required');
        }
