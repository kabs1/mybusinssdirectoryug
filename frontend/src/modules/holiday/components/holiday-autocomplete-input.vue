...
<script>
import HolidayFormModal from '@/modules/holiday/components/holiday-form-modal';
import { HolidayPermissions } from '@/modules/holiday/holiday-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-holiday-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [HolidayFormModal.name]: HolidayFormModal,
  },
