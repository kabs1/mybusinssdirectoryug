...
import documentsListExporterFields from '@/modules/documents/documents-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!documentsListExporterFields || !documentsListExporterFields.length) {
          throw new Error('documentsListExporterFields is required');
        }
