<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/documents/new' }" v-if="hasPermissionToCreate">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'documents' } }"
...
export default {
  name: 'app-documents-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'documents/list/hasRows',
      loading: 'documents/list/loading',
      exportLoading: 'documents/list/exportLoading',
      selectedRows: 'documents/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new DocumentsPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new DocumentsPermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'documents/list/doExport',
      doRemoveAllSelected:
        'documents/list/doRemoveAllSelected',
      doDisableAllSelected:
        'documents/list/doDisableAllSelected',
      doEnableAllSelected:
        'documents/list/doEnableAllSelected',
      doDestroyAll: 'documents/destroy/doDestroyAll',
    }),
