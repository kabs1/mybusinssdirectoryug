...
<script>
import DocumentsFormModal from '@/modules/documents/components/documents-form-modal';
import { DocumentsPermissions } from '@/modules/documents/documents-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-documents-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [DocumentsFormModal.name]: DocumentsFormModal,
  },
