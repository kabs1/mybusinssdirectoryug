<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/variation/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/variation/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'variation' } }"
...
export default {
  name: 'app-variation-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'variation/list/hasRows',
      loading: 'variation/list/loading',
      exportLoading: 'variation/list/exportLoading',
      selectedRows: 'variation/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new VariationPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new VariationPermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'variation/list/doExport',
      doRemoveAllSelected:
        'variation/list/doRemoveAllSelected',
      doDisableAllSelected:
        'variation/list/doDisableAllSelected',
      doEnableAllSelected:
        'variation/list/doEnableAllSelected',
      doDestroyAll: 'variation/destroy/doDestroyAll',
    }),
