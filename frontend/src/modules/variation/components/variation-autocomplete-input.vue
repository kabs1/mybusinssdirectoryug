...
<script>
import VariationFormModal from '@/modules/variation/components/variation-form-modal';
import { VariationPermissions } from '@/modules/variation/variation-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-variation-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [VariationFormModal.name]: VariationFormModal,
  },
