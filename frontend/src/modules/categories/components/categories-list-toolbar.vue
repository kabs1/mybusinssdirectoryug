<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/categories/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

<!--    <router-link :to="{ path: '/categories/import' }" v-if="hasPermissionToImport">-->
...
<!--    <router-link-->
<!--      :to="{ path: '/audit-logs', query: { entityNames: 'categories' } }"-->
...
export default {
  name: 'app-categories-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'categories/list/hasRows',
      loading: 'categories/list/loading',
      exportLoading: 'categories/list/exportLoading',
      selectedRows: 'categories/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new CategoriesPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new CategoriesPermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'categories/list/doExport',
      doRemoveAllSelected:
        'categories/list/doRemoveAllSelected',
      doDisableAllSelected:
        'categories/list/doDisableAllSelected',
      doEnableAllSelected:
        'categories/list/doEnableAllSelected',
      doDestroyAll: 'categories/destroy/doDestroyAll',
    }),
