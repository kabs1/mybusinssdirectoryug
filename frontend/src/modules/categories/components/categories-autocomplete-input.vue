...
<script>
import CategoriesFormModal from '@/modules/categories/components/categories-form-modal';
import { CategoriesPermissions } from '@/modules/categories/categories-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-categories-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [CategoriesFormModal.name]: CategoriesFormModal,
  },
