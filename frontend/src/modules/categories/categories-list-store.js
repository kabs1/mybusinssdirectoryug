...
import categoriesListExporterFields from '@/modules/categories/categories-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!categoriesListExporterFields || !categoriesListExporterFields.length) {
          throw new Error('categoriesListExporterFields is required');
        }
