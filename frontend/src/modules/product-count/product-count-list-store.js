...
import productCountListExporterFields from '@/modules/product-count/product-count-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!productCountListExporterFields || !productCountListExporterFields.length) {
          throw new Error('productCountListExporterFields is required');
        }
        ...
        const response = await ProductCountService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          productCountListExporterFields,
          'productCount',
