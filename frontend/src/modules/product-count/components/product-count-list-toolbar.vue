<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/product-count/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/product-count/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'productCount' } }"
...
export default {
  name: 'app-product-count-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'productCount/list/hasRows',
      loading: 'productCount/list/loading',
      exportLoading: 'productCount/list/exportLoading',
      selectedRows: 'productCount/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new ProductCountPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new ProductCountPermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'productCount/list/doExport',
      doRemoveAllSelected:
        'productCount/list/doRemoveAllSelected',
      doDisableAllSelected:
        'productCount/list/doDisableAllSelected',
      doEnableAllSelected:
        'productCount/list/doEnableAllSelected',
      doDestroyAll: 'productCount/destroy/doDestroyAll',
    }),
