...
<script>
import ReturnsFormModal from '@/modules/returns/components/returns-form-modal';
import { ReturnsPermissions } from '@/modules/returns/returns-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-returns-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [ReturnsFormModal.name]: ReturnsFormModal,
  },
