...
import returnsListExporterFields from '@/modules/returns/returns-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!returnsListExporterFields || !returnsListExporterFields.length) {
          throw new Error('returnsListExporterFields is required');
        }
