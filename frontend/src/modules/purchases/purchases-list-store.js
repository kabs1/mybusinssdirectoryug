...
import purchasesListExporterFields from '@/modules/purchases/purchases-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!purchasesListExporterFields || !purchasesListExporterFields.length) {
          throw new Error('purchasesListExporterFields is required');
        }
