...
<script>
import PurchasesFormModal from '@/modules/purchases/components/purchases-form-modal';
import { PurchasesPermissions } from '@/modules/purchases/purchases-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-purchases-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [PurchasesFormModal.name]: PurchasesFormModal,
  },
