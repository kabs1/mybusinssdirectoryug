...
<script>
import PayrollFormModal from '@/modules/payroll/components/payroll-form-modal';
import { PayrollPermissions } from '@/modules/payroll/payroll-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-payroll-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [PayrollFormModal.name]: PayrollFormModal,
  },
