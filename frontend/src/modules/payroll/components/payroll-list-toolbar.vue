<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/payroll/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

<!--    <router-link :to="{ path: '/payroll/import' }" v-if="hasPermissionToImport">-->
...
<!--    </router-link>-->
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'payroll' } }"
...
export default {
  name: 'app-payroll-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'payroll/list/hasRows',
      loading: 'payroll/list/loading',
      exportLoading: 'payroll/list/exportLoading',
      selectedRows: 'payroll/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new PayrollPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new PayrollPermissions(this.currentUser).import;
    },

    hasPermissionToDestroy() {
      return new PayrollPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'payroll/list/doExport',
      doRemoveAllSelected:
        'payroll/list/doRemoveAllSelected',
      doDisableAllSelected:
        'payroll/list/doDisableAllSelected',
      doEnableAllSelected:
        'payroll/list/doEnableAllSelected',
      doDestroyAll: 'payroll/destroy/doDestroyAll',
    }),
