...
import payrollListExporterFields from '@/modules/payroll/payroll-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!payrollListExporterFields || !payrollListExporterFields.length) {
          throw new Error('payrollListExporterFields is required');
        }
