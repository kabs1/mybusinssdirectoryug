<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/products/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/products/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'products' } }"
...
export default {
  name: 'app-products-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'products/list/hasRows',
      loading: 'products/list/loading',
      exportLoading: 'products/list/exportLoading',
      selectedRows: 'products/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new ProductsPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToDestroy() {
      return new ProductsPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'products/list/doExport',
      doRemoveAllSelected:
        'products/list/doRemoveAllSelected',
      doDisableAllSelected:
        'products/list/doDisableAllSelected',
      doEnableAllSelected:
        'products/list/doEnableAllSelected',
      doDestroyAll: 'products/destroy/doDestroyAll',
    }),
