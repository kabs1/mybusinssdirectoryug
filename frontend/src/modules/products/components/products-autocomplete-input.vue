...
<script>
import ProductsFormModal from '@/modules/products/components/products-form-modal';
import { ProductsPermissions } from '@/modules/products/products-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-products-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [ProductsFormModal.name]: ProductsFormModal,
  },
