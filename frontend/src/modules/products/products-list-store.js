...
import productsListExporterFields from '@/modules/products/products-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!productsListExporterFields || !productsListExporterFields.length) {
          throw new Error('productsListExporterFields is required');
        }
