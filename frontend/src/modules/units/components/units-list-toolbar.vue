<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'units' } }"
...
export default {
  name: 'app-units-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'units/list/hasRows',
      loading: 'units/list/loading',
      exportLoading: 'units/list/exportLoading',
      selectedRows: 'units/list/selectedRows',
    ...
    hasPermissionToImport() {
      return new UnitsPermissions(this.currentUser).import;
    },
