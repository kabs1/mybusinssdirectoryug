...
<script>
import UnitsFormModal from '@/modules/units/components/units-form-modal';
import { UnitsPermissions } from '@/modules/units/units-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-units-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [UnitsFormModal.name]: UnitsFormModal,
  },
