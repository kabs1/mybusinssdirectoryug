...
import giftCardListExporterFields from '@/modules/gift-card/gift-card-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!giftCardListExporterFields || !giftCardListExporterFields.length) {
          throw new Error('giftCardListExporterFields is required');
        }
