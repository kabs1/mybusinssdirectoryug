...
<script>
import GiftCardFormModal from '@/modules/gift-card/components/gift-card-form-modal';
import { GiftCardPermissions } from '@/modules/gift-card/gift-card-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-gift-card-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [GiftCardFormModal.name]: GiftCardFormModal,
  },
