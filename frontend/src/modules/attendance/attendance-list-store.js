...
import attendanceListExporterFields from '@/modules/attendance/attendance-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!attendanceListExporterFields || !attendanceListExporterFields.length) {
          throw new Error('attendanceListExporterFields is required');
        }
