<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/attendance/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/attendance/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'attendance' } }"
...
export default {
  name: 'app-attendance-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'attendance/list/hasRows',
      loading: 'attendance/list/loading',
      exportLoading: 'attendance/list/exportLoading',
      selectedRows: 'attendance/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new AttendancePermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new AttendancePermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'attendance/list/doExport',
      doRemoveAllSelected:
        'attendance/list/doRemoveAllSelected',
      doDisableAllSelected:
        'attendance/list/doDisableAllSelected',
      doEnableAllSelected:
        'attendance/list/doEnableAllSelected',
      doDestroyAll: 'attendance/destroy/doDestroyAll',
    }),
