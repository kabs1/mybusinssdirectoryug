<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/currency/new' }" v-if="hasPermissionToCreate">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'currency' } }"
...
export default {
  name: 'app-currency-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'currency/list/hasRows',
      loading: 'currency/list/loading',
      exportLoading: 'currency/list/exportLoading',
      selectedRows: 'currency/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new CurrencyPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new CurrencyPermissions(this.currentUser).import;
    },

    hasPermissionToDestroy() {
      return new CurrencyPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'currency/list/doExport',
      doRemoveAllSelected:
        'currency/list/doRemoveAllSelected',
      doDisableAllSelected:
        'currency/list/doDisableAllSelected',
      doEnableAllSelected:
        'currency/list/doEnableAllSelected',
      doDestroyAll: 'currency/destroy/doDestroyAll',
    }),
