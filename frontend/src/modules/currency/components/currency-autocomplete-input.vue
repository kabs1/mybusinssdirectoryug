...
<script>
import CurrencyFormModal from '@/modules/currency/components/currency-form-modal';
import { CurrencyPermissions } from '@/modules/currency/currency-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-currency-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [CurrencyFormModal.name]: CurrencyFormModal,
  },
