...
import currencyListExporterFields from '@/modules/currency/currency-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!currencyListExporterFields || !currencyListExporterFields.length) {
          throw new Error('currencyListExporterFields is required');
        }
