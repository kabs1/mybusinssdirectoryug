...
import couponListExporterFields from '@/modules/coupon/coupon-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!couponListExporterFields || !couponListExporterFields.length) {
          throw new Error('couponListExporterFields is required');
        }
