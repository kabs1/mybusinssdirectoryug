...
<script>
import CouponFormModal from '@/modules/coupon/components/coupon-form-modal';
import { CouponPermissions } from '@/modules/coupon/coupon-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-coupon-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [CouponFormModal.name]: CouponFormModal,
  },
