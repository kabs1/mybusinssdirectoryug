...
<script>
import TaxClassFormModal from '@/modules/tax-class/components/tax-class-form-modal';
import { TaxClassPermissions } from '@/modules/tax-class/tax-class-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-tax-class-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [TaxClassFormModal.name]: TaxClassFormModal,
  },
