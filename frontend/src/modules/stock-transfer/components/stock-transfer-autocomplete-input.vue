...
<script>
import StockTransferFormModal from '@/modules/stock-transfer/components/stock-transfer-form-modal';
import { StockTransferPermissions } from '@/modules/stock-transfer/stock-transfer-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-stock-transfer-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [StockTransferFormModal.name]: StockTransferFormModal,
  },
