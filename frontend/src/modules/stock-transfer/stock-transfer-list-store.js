...
import stockTransferListExporterFields from '@/modules/stock-transfer/stock-transfer-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!stockTransferListExporterFields || !stockTransferListExporterFields.length) {
          throw new Error('stockTransferListExporterFields is required');
        }
        ...
        const response = await StockTransferService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          stockTransferListExporterFields,
          'stockTransfer',
