...
import deviceSessionsListExporterFields from '@/modules/device-sessions/device-sessions-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!deviceSessionsListExporterFields || !deviceSessionsListExporterFields.length) {
          throw new Error('deviceSessionsListExporterFields is required');
        }
        ...
        const response = await DeviceSessionsService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          deviceSessionsListExporterFields,
          'deviceSessions',
