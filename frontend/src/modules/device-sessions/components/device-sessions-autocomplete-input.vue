<template>
  <div style="display: flex">
    ...
    ></el-button>
    <portal to="modal">
      <app-device-sessions-form-modal
...
<script>
import DeviceSessionsFormModal from '@/modules/device-sessions/components/device-sessions-form-modal';
import { DeviceSessionsPermissions } from '@/modules/device-sessions/device-sessions-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-device-sessions-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [DeviceSessionsFormModal.name]: DeviceSessionsFormModal,
  },
