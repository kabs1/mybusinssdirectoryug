...
<script>
import TransactionsFormModal from '@/modules/transactions/components/transactions-form-modal';
import { TransactionsPermissions } from '@/modules/transactions/transactions-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-transactions-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [TransactionsFormModal.name]: TransactionsFormModal,
  },
