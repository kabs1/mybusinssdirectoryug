...
import transactionsListExporterFields from '@/modules/transactions/transactions-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!transactionsListExporterFields || !transactionsListExporterFields.length) {
          throw new Error('transactionsListExporterFields is required');
        }
        ...
        new Exporter(
          transactionsListExporterFields,
          'transactions',
