...
import allowanceAndDeductionListExporterFields from '@/modules/allowance-and-deduction/allowance-and-deduction-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!allowanceAndDeductionListExporterFields || !allowanceAndDeductionListExporterFields.length) {
          throw new Error('allowanceAndDeductionListExporterFields is required');
        }
        ...
        const response = await AllowanceAndDeductionService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          allowanceAndDeductionListExporterFields,
