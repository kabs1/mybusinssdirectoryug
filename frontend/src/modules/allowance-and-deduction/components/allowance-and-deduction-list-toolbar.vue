<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/allowance-and-deduction/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/allowance-and-deduction/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'allowanceAndDeduction' } }"
...
export default {
  name: 'app-allowance-and-deduction-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'allowanceAndDeduction/list/hasRows',
      loading: 'allowanceAndDeduction/list/loading',
      exportLoading: 'allowanceAndDeduction/list/exportLoading',
      selectedRows: 'allowanceAndDeduction/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new AllowanceAndDeductionPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToDestroy() {
      return new AllowanceAndDeductionPermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'allowanceAndDeduction/list/doExport',
      doRemoveAllSelected:
        'allowanceAndDeduction/list/doRemoveAllSelected',
      doDisableAllSelected:
        'allowanceAndDeduction/list/doDisableAllSelected',
      doEnableAllSelected:
        'allowanceAndDeduction/list/doEnableAllSelected',
      doDestroyAll: 'allowanceAndDeduction/destroy/doDestroyAll',
    }),
