<template>
  <div style="display: flex">
    ...
    ></el-button>
    <portal to="modal">
      <app-allowance-and-deduction-form-modal
...
<script>
import AllowanceAndDeductionFormModal from '@/modules/allowance-and-deduction/components/allowance-and-deduction-form-modal';
import { AllowanceAndDeductionPermissions } from '@/modules/allowance-and-deduction/allowance-and-deduction-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-allowance-and-deduction-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [AllowanceAndDeductionFormModal.name]: AllowanceAndDeductionFormModal,
  },
