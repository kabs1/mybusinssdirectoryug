<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/document-types/new' }" v-if="hasPermissionToCreate">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'documentTypes' } }"
...
export default {
  name: 'app-document-types-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'documentTypes/list/hasRows',
      loading: 'documentTypes/list/loading',
      exportLoading: 'documentTypes/list/exportLoading',
      selectedRows: 'documentTypes/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new DocumentTypesPermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new DocumentTypesPermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'documentTypes/list/doExport',
      doRemoveAllSelected:
        'documentTypes/list/doRemoveAllSelected',
      doDisableAllSelected:
        'documentTypes/list/doDisableAllSelected',
      doEnableAllSelected:
        'documentTypes/list/doEnableAllSelected',
      doDestroyAll: 'documentTypes/destroy/doDestroyAll',
    }),
