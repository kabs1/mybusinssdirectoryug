...
import documentTypesListExporterFields from '@/modules/document-types/document-types-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!documentTypesListExporterFields || !documentTypesListExporterFields.length) {
          throw new Error('documentTypesListExporterFields is required');
        }
        ...
        const response = await DocumentTypesService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          documentTypesListExporterFields,
          'documentTypes',
