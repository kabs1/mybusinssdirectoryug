...
<script>
import StallFormModal from '@/modules/stall/components/stall-form-modal';
import { StallPermissions } from '@/modules/stall/stall-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-stall-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [StallFormModal.name]: StallFormModal,
  },
