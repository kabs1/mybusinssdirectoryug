...
import brandsListExporterFields from '@/modules/brands/brands-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!brandsListExporterFields || !brandsListExporterFields.length) {
          throw new Error('brandsListExporterFields is required');
        }
