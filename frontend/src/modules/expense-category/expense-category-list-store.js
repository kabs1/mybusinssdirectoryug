...
import expenseCategoryListExporterFields from '@/modules/expense-category/expense-category-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!expenseCategoryListExporterFields || !expenseCategoryListExporterFields.length) {
          throw new Error('expenseCategoryListExporterFields is required');
        }
        ...
        const response = await ExpenseCategoryService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          expenseCategoryListExporterFields,
          'expenseCategory',
