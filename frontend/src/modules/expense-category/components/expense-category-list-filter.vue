<template>
  ...
  >
    <el-row>
        <el-form-item :prop="fields.expCategoryTitle.name">
          <el-input :placeholder="fields.expCategoryTitle.label" v-model="model[fields.expCategoryTitle.name]"/>
        </el-form-item>
    </el-row>
...
export default {
  name: 'app-expense-category-list-filter',
  ...
  computed: {
    ...mapGetters({
      ...
      filter: 'expenseCategory/list/filter',
    }),
  ...
  methods: {
    ...mapActions({
      doReset: 'expenseCategory/list/doReset',
      doFetch: 'expenseCategory/list/doFetch',
    }),
