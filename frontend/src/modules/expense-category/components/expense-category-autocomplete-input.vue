<template>
  <div style="display: flex">
    ...
    ></el-button>
    <portal to="modal">
      <app-expense-category-form-modal
...
<script>
import ExpenseCategoryFormModal from '@/modules/expense-category/components/expense-category-form-modal';
import { ExpenseCategoryPermissions } from '@/modules/expense-category/expense-category-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-expense-category-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [ExpenseCategoryFormModal.name]: ExpenseCategoryFormModal,
  },
