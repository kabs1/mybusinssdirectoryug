    ...
    >
      <el-form-item :label="fields.id.label" :prop="fields.id.name" v-if="isEditing">
        <el-col :lg="11" :md="16" :sm="24">
          ...
          :required="fields.expCategoryTitle.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input v-model="model[fields.expCategoryTitle.name]" ref="focus" />
          </el-col>
        </el-form-item>
        ...
        <el-form-item
          ...
          :required="fields.expCategoryDetails.required"
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-input :rows="4" type="textarea" v-model="model[fields.expCategoryDetails.name]" />
          </el-col>
        </el-form-item>
      <el-form-item>
...
export default {
  name: 'app-expense-category-form',
