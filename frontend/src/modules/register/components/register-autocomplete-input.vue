...
<script>
import RegisterFormModal from '@/modules/register/components/register-form-modal';
import { RegisterPermissions } from '@/modules/register/register-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-register-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [RegisterFormModal.name]: RegisterFormModal,
  },
