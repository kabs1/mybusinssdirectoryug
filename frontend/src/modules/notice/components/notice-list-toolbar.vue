<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/notice/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

<!--    <router-link :to="{ path: '/notice/import' }" v-if="hasPermissionToImport">-->
...
<!--    </router-link>-->
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'notice' } }"
...
export default {
  name: 'app-notice-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'notice/list/hasRows',
      loading: 'notice/list/loading',
      exportLoading: 'notice/list/exportLoading',
      selectedRows: 'notice/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new NoticePermissions(this.currentUser).create;
    },
    ...
    hasPermissionToDestroy() {
      return new NoticePermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'notice/list/doExport',
      doRemoveAllSelected:
        'notice/list/doRemoveAllSelected',
      doDisableAllSelected:
        'notice/list/doDisableAllSelected',
      doEnableAllSelected:
        'notice/list/doEnableAllSelected',
      doDestroyAll: 'notice/destroy/doDestroyAll',
    }),
