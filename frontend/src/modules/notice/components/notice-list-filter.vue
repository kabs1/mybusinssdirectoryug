<template>
  ...
  >
    <el-row>
        ...
        <el-form-item :label="fields.noticeTitle.label" :prop="fields.noticeTitle.name">
          <el-input v-model="model[fields.noticeTitle.name]"/>
        </el-form-item>
      
        <el-form-item :label="fields.noticeType.label" :prop="fields.noticeType.name">
...
export default {
  ...
  methods: {
    ...mapActions({
      doReset: 'notice/list/doReset',
      doFetch: 'notice/list/doFetch',
    }),
