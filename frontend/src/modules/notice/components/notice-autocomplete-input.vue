...
<script>
import NoticeFormModal from '@/modules/notice/components/notice-form-modal';
import { NoticePermissions } from '@/modules/notice/notice-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-notice-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [NoticeFormModal.name]: NoticeFormModal,
  },
