...
import devicesListExporterFields from '@/modules/devices/devices-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!devicesListExporterFields || !devicesListExporterFields.length) {
          throw new Error('devicesListExporterFields is required');
        }
