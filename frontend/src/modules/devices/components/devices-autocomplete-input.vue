...
<script>
import DevicesFormModal from '@/modules/devices/components/devices-form-modal';
import { DevicesPermissions } from '@/modules/devices/devices-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-devices-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [DevicesFormModal.name]: DevicesFormModal,
  },
