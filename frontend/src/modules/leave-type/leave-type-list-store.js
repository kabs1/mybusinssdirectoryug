...
import leaveTypeListExporterFields from '@/modules/leave-type/leave-type-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!leaveTypeListExporterFields || !leaveTypeListExporterFields.length) {
          throw new Error('leaveTypeListExporterFields is required');
        }
