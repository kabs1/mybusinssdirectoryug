...
<script>
import LeaveTypeFormModal from '@/modules/leave-type/components/leave-type-form-modal';
import { LeaveTypePermissions } from '@/modules/leave-type/leave-type-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-leave-type-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [LeaveTypeFormModal.name]: LeaveTypeFormModal,
  },
