<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/leave-type/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

<!--    <router-link :to="{ path: '/leave-type/import' }" v-if="hasPermissionToImport">-->
...
<!--    </router-link>-->
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'leaveType' } }"
...
export default {
  name: 'app-leave-type-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'leaveType/list/hasRows',
      loading: 'leaveType/list/loading',
      exportLoading: 'leaveType/list/exportLoading',
      selectedRows: 'leaveType/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new LeaveTypePermissions(this.currentUser).create;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'leaveType/list/doExport',
      doRemoveAllSelected:
        'leaveType/list/doRemoveAllSelected',
      doDisableAllSelected:
        'leaveType/list/doDisableAllSelected',
      doEnableAllSelected:
        'leaveType/list/doEnableAllSelected',
      doDestroyAll: 'leaveType/destroy/doDestroyAll',
    }),
