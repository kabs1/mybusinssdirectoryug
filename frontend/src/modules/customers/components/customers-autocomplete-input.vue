...
<script>
import CustomersFormModal from '@/modules/customers/components/customers-form-modal';
import { CustomersPermissions } from '@/modules/customers/customers-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-customers-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [CustomersFormModal.name]: CustomersFormModal,
  },
