...
import customersListExporterFields from '@/modules/customers/customers-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!customersListExporterFields || !customersListExporterFields.length) {
          throw new Error('customersListExporterFields is required');
        }
