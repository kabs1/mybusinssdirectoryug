<template>
  <div style="display: flex">
    ...
    ></el-button>
    <portal to="modal">
      <app-stock-adjustments-form-modal
...
<script>
import StockAdjustmentsFormModal from '@/modules/stock-adjustments/components/stock-adjustments-form-modal';
import { StockAdjustmentsPermissions } from '@/modules/stock-adjustments/stock-adjustments-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-stock-adjustments-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [StockAdjustmentsFormModal.name]: StockAdjustmentsFormModal,
  },
