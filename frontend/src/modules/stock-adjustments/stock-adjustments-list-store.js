...
import stockAdjustmentsListExporterFields from '@/modules/stock-adjustments/stock-adjustments-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!stockAdjustmentsListExporterFields || !stockAdjustmentsListExporterFields.length) {
          throw new Error('stockAdjustmentsListExporterFields is required');
        }
        ...
        new Exporter(
          stockAdjustmentsListExporterFields,
          'stockAdjustments',
