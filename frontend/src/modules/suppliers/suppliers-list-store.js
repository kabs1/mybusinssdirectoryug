...
import suppliersListExporterFields from '@/modules/suppliers/suppliers-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!suppliersListExporterFields || !suppliersListExporterFields.length) {
          throw new Error('suppliersListExporterFields is required');
        }
