...
<script>
import LeaveFormModal from '@/modules/leave/components/leave-form-modal';
import { LeavePermissions } from '@/modules/leave/leave-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-leave-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [LeaveFormModal.name]: LeaveFormModal,
  },
