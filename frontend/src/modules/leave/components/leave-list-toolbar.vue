<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/leave/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary" round>
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

<!--    <router-link :to="{ path: '/leave/import' }" v-if="hasPermissionToImport">-->
...
<!--    </router-link>-->
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'leave' } }"
...
export default {
  name: 'app-leave-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'leave/list/hasRows',
      loading: 'leave/list/loading',
      exportLoading: 'leave/list/exportLoading',
      selectedRows: 'leave/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new LeavePermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new LeavePermissions(this.currentUser).import;
    },

    hasPermissionToDestroy() {
      return new LeavePermissions(this.currentUser)
        .destroy;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'leave/list/doExport',
      doRemoveAllSelected:
        'leave/list/doRemoveAllSelected',
      doDisableAllSelected:
        'leave/list/doDisableAllSelected',
      doEnableAllSelected:
        'leave/list/doEnableAllSelected',
      doDestroyAll: 'leave/destroy/doDestroyAll',
    }),
