...
<script>
import DamagesFormModal from '@/modules/damages/components/damages-form-modal';
import { DamagesPermissions } from '@/modules/damages/damages-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-damages-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [DamagesFormModal.name]: DamagesFormModal,
  },
