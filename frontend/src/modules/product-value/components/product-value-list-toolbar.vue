<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/product-value/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/product-value/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'productValue' } }"
...
export default {
  name: 'app-product-value-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'productValue/list/hasRows',
      loading: 'productValue/list/loading',
      exportLoading: 'productValue/list/exportLoading',
      selectedRows: 'productValue/list/selectedRows',
    ...
    hasPermissionToCreate() {
      return new ProductValuePermissions(this.currentUser).create;
    },
    ...
    hasPermissionToImport() {
      return new ProductValuePermissions(this.currentUser).import;
    },
  ...
  methods: {
    ...mapActions({
      doExport: 'productValue/list/doExport',
      doRemoveAllSelected:
        'productValue/list/doRemoveAllSelected',
      doDisableAllSelected:
        'productValue/list/doDisableAllSelected',
      doEnableAllSelected:
        'productValue/list/doEnableAllSelected',
      doDestroyAll: 'productValue/destroy/doDestroyAll',
    }),
