...
import productValueListExporterFields from '@/modules/product-value/product-value-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!productValueListExporterFields || !productValueListExporterFields.length) {
          throw new Error('productValueListExporterFields is required');
        }
        ...
        const response = await ProductValueService.list(
          filter,
          getters.orderBy,
          null,
          null,
        ...
        new Exporter(
          productValueListExporterFields,
          'productValue',
