...
<script>
import ProductLogsFormModal from '@/modules/product-logs/components/product-logs-form-modal';
import { ProductLogsPermissions } from '@/modules/product-logs/product-logs-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-product-logs-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [ProductLogsFormModal.name]: ProductLogsFormModal,
  },
