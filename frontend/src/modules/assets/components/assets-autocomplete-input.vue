...
<script>
import AssetsFormModal from '@/modules/assets/components/assets-form-modal';
import { AssetsPermissions } from '@/modules/assets/assets-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-assets-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [AssetsFormModal.name]: AssetsFormModal,
  },
