...
import assetsListExporterFields from '@/modules/assets/assets-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (!assetsListExporterFields || !assetsListExporterFields.length) {
          throw new Error('assetsListExporterFields is required');
        }
